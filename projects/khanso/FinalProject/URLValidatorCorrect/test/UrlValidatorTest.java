...
public class UrlValidatorTest extends TestCase {
   ...
   public void testIsValid(Object[] testObjects, long options) {
      ...
      int[] resArray = new int[] {numTested, errors, numPassed};
       System.out.print(Arrays.toString(resArray));
   }
   ...
   public void testValidator218() {
    ...
    /**
     * NOTE: this goes through all the testParts and tries to increment the corresponding index in testPartsIndex
     * when all the testPartsIndices are incremented to their max length, incrementTestPartsIndex returns false
     *
     */
